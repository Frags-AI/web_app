...
import { Html, Button, Body, Preview, Tailwind, Text, Head} from "@react-email/components"
...
export const ClipsReady: React.FC<ClipReadyProps> = ({url, email}) => {
    ...
    return  (
      <Html>
          <Head />
          <Preview>Access your video clips</Preview>
          <Tailwind>
            <Body className="font-sans flex flex-col items-center gap-2">
                <Text className="font-bold text-2xl text-black">Your clips are ready to be viewed</Text>
                ...
                <Text className="font-bold text-4xl text-black">Frags AI</Text>
